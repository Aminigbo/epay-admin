          ...
          return (
            <>
              ...
              <div style={{ background: "" }}>
                ...
                >
                  <small>
                   You have recieved a payment of{" "}
                    <b
                      style={{
                        color: "#0a3d62",
                        padding: "3px 4px",
                  ...
                  <br />
                  <small>
                    <span style={{ color: "mediumseagreen" }}>Service charge</span>:
                    &nbsp;
                    <div
                      style={{
                        float: "right",
                    ...
                    >
                      <Naira>
                        {e.meta.serviceCharge}
                      </Naira>
                    </div>
                  </small>{" "}
                  <br />
                  <small>
                    <span style={{ color: "mediumseagreen" }}>Amount cradited</span>:
                    &nbsp;
                    <div
                      style={{
                        float: "right",
                  ...
                  <br />
                  <small>
                    <span style={{ color: "mediumseagreen" }}>Customer</span>:
                    &nbsp;
                    <div
                      style={{
                        float: "right",
