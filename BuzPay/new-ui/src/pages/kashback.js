            ...
            >
               ...
               >
                  <div style={{
                     ...
                     <b style={{ width: "", position: "absolute", left: "20px", bottom: "15px" }} >Aminigbo Paul</b>
                     <b style={{ width: "", position: "absolute", right: "20px", bottom: "15px" }} >{new Date().getDate()}/{new Date().getMonth() + 1}/{year}</b>
                        ...
                        {amount < 500 ? <small style={{ color: "crimson" }}>Minimum amount is ₦500</small> : <>
                           {amount > parseInt(state.userData.wallet) ? <small style={{ color: "crimson" }}>You have insufficient fund</small> :
                              <>
                                 ...
                                 {status == true ?
                                    <>
                                       {tokendata && <>  <QRCode value={tokendata.toString()} /></>}
                                    </> :
                                    <input
                                       type="button"
                  ...
                  >
                     ...
                     <div style={{
                        ...
                        <div
                           ...
                           value={amount}
                           style={{
                              position: "absolute", left: "5%", bottom: "40%", color: "white", width: "90%",
                           ...
                           You will be charged ₦{separator(80)} as service fee.
                        </div>
                        <b style={{ width: "", position: "absolute", left: "20px", bottom: "5px", fontSize: "20px" }} >₦{separator(amount)}</b>
                        <small style={{ width: "", position: "absolute", right: "20px", bottom: "5px" }} >{new Date().getDate()}/{new Date().getMonth() + 1}/{year}</small>
                     </div>

                     <div style={{ marginTop: "20px", marginBottom: "35px" }}>
                        <small>Enter pin to authorize this transaction.</small>
                        <div
                           style={{
                              padding: "15px",
                              // background: "black",
