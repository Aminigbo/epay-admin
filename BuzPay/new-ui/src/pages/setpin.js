   ...
   const verify = () => {
      if (pin.length == 4) {
         if (first === null) {
            ...
            if (first == pin) {
               // setfirst(true)
               let btnAction = () => { history.push("/") }
               let message = "Security pin has been set successfully"

               return loader("SETPIN", updateUserMetaController, setloading, loading, pin, successAlert, btnAction, message, login_suc)
               ...
               >
                  ...
                  >
                     ...
                     <div style={{ marginBottom: "50px", height: "130px", background: " ", position: "relative", width: "90%", padding: "0px 30px" }}>
                        ...
                        <div style={{ position: "absolute", top: "65px", fontSize: "" }} >
                           <b style={{ fontSize: "19px", color: "#073F74" }}>Create Your buzzpay Pin</b>

                           <div>
                              <small> This pin would be used when ever you are to login </small>
                           </div>
                        </div>
                  ...
                  >
                     ...
                     <div style={{ color: "black", marginTop: "10px" }}>
                        {error == false ? <>
                           {first !== null && <>Re-enter pin</>}
                        </> : <><small style={{ color: "crimson" }}>Pin do not match</small></>}
