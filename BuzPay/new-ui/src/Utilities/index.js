...
export const API_URL = 'https://pay.harvoxx.com/images/tickets/'
...
// @======== 
export function buzzPayChargeOnKashbak(amount) {
  let charge = "";
  if (amount > 499 && amount < 2001) {
    charge = 5;
  }
   else if (amount > 1999 && amount < 5001) {
    charge = 10;
  }
