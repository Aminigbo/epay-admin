...
function VendorMyProducts({ session }) {
  ...
  //     title: <strong>Withdrawal unavailable</strong>,
  //     html: <i>Sorry, withdrawal is currently unavailable at this time.</i>,
  //     icon: "info",
  //     // showCancelButton: true,
  //     confirmButtonText: "Ok",
  //   });
  ...
  //     alert(error.message);
  //   } else if (products) {
  //     setNoOfItems(products.length);
  //     setLoading(false);
  //   }
  // }

  // async function getNoOfOrders() {
  //   setLoading(true);
  //   let { data: ordered_products, error } = await supabase
  //     .from("ordered_products")
  //     .select("*")
  ...
  //     alert(error.message);
  //   } else if (ordered_products) {
  //     setNoOfItems(ordered_products.length);
  //     setLoading(false);
  //   }
  // }
            ...
            <div className="overview-container">
              <div class="box">
                ...
                <span className="sub-title">
                  {noOfItems ? noOfItems : "0"} Item(s)
                </span>
              </div>

              <div class="box">
                <span className="title">Recent Orders</span>
                <span className="sub-title">
                  {noOfOrders ? noOfOrders : "0"} Order(s)
                </span>
              </div>
              ...
              <div class="box">
                ...
                <span className="sub-title">
                  ${details ? details.total_earnings : ""}
                </span>
              </div>
            </div>
          </div>
